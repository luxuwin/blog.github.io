...
With very minimal use, it stopped working in fall before winter came. It won't start. Checked various components, pump, motor, pipe and etc.. Contacted the support and replaced a new controller, which eventually fixed the issue. 
After re-installation, the fan started making noises. Apparently it is scratching the housing. I had to sand away some plastic.

Anyway, it is working again, and we are warm!
